 ...
 * deduplicación del plan 02 no puede reconocerlas. La limpieza vive en
 * `domain/text/bank-description.ts`, compartida con el comercio del sprint 05.
 */
export function normalizeDescription(raw: string): string {
  return basicClean(raw);
}
